...
class QueriesControllerTest < ActionController::TestCase
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post :create, query: { deleted_at: @query.deleted_at, query: @query.query, user_id: @query.user_id }
    end
  ...
  test "should update query" do
    patch :update, id: @query, query: { deleted_at: @query.deleted_at, query: @query.query, user_id: @query.user_id }
    assert_redirected_to query_path(assigns(:query))
  end
